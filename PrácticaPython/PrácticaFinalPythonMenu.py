...
while stayCurious:
    ...
    print(Fore.WHITE + "*Accedes a la Sala Suma del Consejo Primordial de MounTime Project*"
          ...
          + "\n"
          + Fore.LIGHTRED_EX + "8. Nombrar un nuevo Gran Maestre. (DEMIURGO: SÓLO EL GRAN MAESTRE SE ATREVERÍA A CEDER TITÁNICA DESVENTURA A OTRO MORTAL.)"
          + "\n"
          + Fore.WHITE + "9. Salir."
          + "\n______________________________________________________________________")
    sleep(0.5)
    ...
    if numMenu == "1":
        print(Fore.WHITE + "\n*Muestras la marca de la estrella de 6 puntas y a continuación alguien estrecha su mano siguiendo el protocolo masónico.*\n" + Fore.RESET)
        sleep(3)
        if usuarioactual != usuarios[0]:
            ...
            print(Fore.LIGHTBLUE_EX + "DEMIURGO : " + Fore.WHITE + "(Le sonríe al Gran Maestre) " + Fore.RESET + Fore.LIGHTBLUE_EX + "Bienvenido mi viejo amigo, " + Fore.RESET + Fore.LIGHTMAGENTA_EX + usuarioactual["Nombre"] + Fore.RESET + Fore.LIGHTBLUE_EX + " ¿Cómo va esa simulación de espacios no euclidianos en Unreal Engine 5?" + Fore.RESET)
        continueButton = str(input("\n- Pulse ENTER para continuar -\n"))
        ...
        print(Fore.LIGHTBLUE_EX + "\nDEMIURGO : Comienzo de la lista de miembros:\n" + Fore.RESET)
        ...
        name = input(Fore.LIGHTBLUE_EX + "\nDEMIURGO : Inserte un nombre de usuario para obtener su información\n" + Fore.RESET)
        datosRecopilados = datosIniciado(name)
        if datosRecopilados != None:
            mensaje6= Fore.LIGHTBLUE_EX + "DEMIURGO : Los datos del usuario solicitado son los siguientes: " + Fore.RESET
        else:
            mensaje6= Fore.LIGHTBLUE_EX + "DEMIURGO : El iniciado no existe." + Fore.RESET
        print(mensaje6)
    ...
    # administrador me muestre un mensaje distinto al de no existe.
        ...
        if usuarioactual is None:
            ...
            mensaje7 = Fore.LIGHTBLUE_EX + "DEMIURGO : Se ha invocado al Gran Maestre " + Fore.RESET + Fore.MAGENTA + usuarioactual["Nombre"] + " de nuevo a la tribuna." + Fore.RESET
