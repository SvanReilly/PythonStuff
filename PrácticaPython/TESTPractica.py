...
while stayCurious:
    ...
    if numMenu == "1":
        ...
        if usuarioactual != usuarios[0]:
            ...
            print(Fore.LIGHTBLUE_EX + "DEMIURGO : " + Fore.WHITE + "*Sonríe al Gran Maestre* " + Fore.RESET + Fore.LIGHTBLUE_EX + "Bienvenido mi viejo amigo, " + Fore.RESET + Fore.LIGHTMAGENTA_EX + usuarioactual["Nombre"] + Fore.RESET + Fore.LIGHTBLUE_EX + " ¿Cómo va esa simulación de espacios no euclidianos en Unreal Engine 5?" + Fore.RESET)
        continueButton = str(input("\n- Pulse ENTER para continuar -\n"))
